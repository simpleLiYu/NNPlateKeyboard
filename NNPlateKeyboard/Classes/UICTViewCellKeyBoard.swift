    ...
    var isEnabledStatus: Bool = true{
        willSet{
            ...
            if isSure {
                ...
                backImgView.image = NNPlateKeyboard.image(named:"btn_normal")
            }
        }
    }
...
//        backImgView.backgroundColor = UIColor.white
        ...
        backImgView.image = NNPlateKeyboard.image(named:"btn_normal")
        backImgView.highlightedImage = NNPlateKeyboard.image(named:"btn_pressed")
    ...
    override func observeValue(forKeyPath keyPath: String?, of object: Any?, change: [NSKeyValueChangeKey : Any]?, context: UnsafeMutableRawPointer?) {
        if keyPath == "text" {
            ...
            case "删除":
                ...
                backImgView.image = NNPlateKeyboard.image(named:"btn_normal")
                backImgView.highlightedImage = NNPlateKeyboard.image(named:"btn_pressed")
                iconImgView.image = NNPlateKeyboard.image(named:"delete")
                iconImgView.highlightedImage = NNPlateKeyboard.image(named:"delete")
